...
5.  create database migrations for the tables. We will place these under `db/migrations/`:

    `db/migrations/20160730004705_create_people.sql`:
    ...
    `db/migrations/20160730024335_create_friendships.sql`:
